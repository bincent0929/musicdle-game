import type { ITunesTrack, ITunesSearchResponse, ITunesRSSEntry, ITunesRSSResponse } from "../scripts/api-types.js";

import type { currentSong } from "../scripts/game-logic-types.js";
